    ...
    <div className=" bg-black text-white fixed top-0 left-0 w-full z-10 ">
      ...
      <div className="hidden md:block">
        <ul className="flex space-x-4 text-md">
          <li>
            <Link href="/">
              <div className="hover:text-gray-700 transition-colors">Home</div>
            </Link>
          </li>
          <li>
            <Link href="/about">
        ...
        <ul className="bg-black text-white py-2">
          ...
          <li className="px-4 py-2">
            <div className="hover:text-gray-700 transition-colors" onClick={toggleMenu}>More</div>
            <ul className={isOpen ? "block" : "hidden"}>
              <li>
                <Link href="/blogs">
                  <div className="block text-white px-4 py-2 hover:bg-gray-800">Blogs</div>
                </Link>
              </li>
              <li>
                <Link href="/faq">
                  <div className="block text-white px-4 py-2 hover:bg-gray-800">FAQ</div>
                </Link>
              </li>
            </ul>
          </li>
