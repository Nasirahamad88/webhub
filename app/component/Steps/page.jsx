  ...
  return (
    <section className=" text-black text-center justify-center  px-4 py-16 bg-slate-900 ">
      ...
      <div className=" sm:grid-cols-2 md:grid-cols-3 gap-8">
        {/* Step 1: Strategy */}
        <div className="rounded-lg shadow-md bg-slate-900 p-8 lg:flex items-center justify-center ">
          <h3 className="text-4xl font-bold mb-4  lg:w-1/3 mx-auto">
            ...
            width={400}
            height={200}
            className=" mb-4 rounded-full border-8 border-sky-500  lg:w-1/3 mx-auto "
            // layout="fill"
            objectFit="cover"
          />
          
          <p className="mb-4  lg:w-1/3 mx-auto">
        ...
        {/* Step 2: Design */}
        <div className="rounded-lg bg-slate-900 shadow-md p-8 lg:flex items-center justify-center ">
          <p className="mb-4 lg:w-1/3 mx-auto">
          ...
          <h3 className="text-4xl font-bold mb-4  lg:w-1/3 mx-auto">
            <span className="text-blue-500">02</span> Design
              ...
              {/* Step 3: Develop */}
              <div className="rounded-lg bg-slate-900 shadow-md  p-8 lg:flex items-center justify-center ">
          <h3 className=" font-bold mb-4  lg:w-1/3 mx-auto text-4xl">
         ...
         <p className="mb-4  lg:w-1/3 mx-auto">
            ...
            objectFit="cover"
          />
          <h3 className=" font-bold mb-4 text-4xl lg:w-1/3 mx-auto">
