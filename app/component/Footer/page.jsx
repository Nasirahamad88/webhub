...
const Footer = () => {
  return (
    <>
      <footer className=" relative z-10 bg-black text-white pb-10 pt-20  dark:bg-dark lg:pb-20 lg:pt-[120px]">
        <div className="container  w-[90%] mx-auto">
          <div className="-mx-4  flex flex-wrap">
            <div className=" px-4 w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  Elevating Brands through Web Mastery, SEO Wizardry, and Graphic Brilliance.
                </p>
            ...
            <LinkGroup header="Company">
              <NavLink link="/about" label="About WebHub" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <Link
                    href="https://www.facebook.com/WebServeHub"
                  ...
                  <Link
                   href="https://www.upwork.com/freelancers/~01d24ca3544ed5f390"
                    className="mr-3 flex h-8 w-8 items-center justify-center font-bold px-4 text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4"
                        >
                      <p>Upwork</p>
                  </Link>
